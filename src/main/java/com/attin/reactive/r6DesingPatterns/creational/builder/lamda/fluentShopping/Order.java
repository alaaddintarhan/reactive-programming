package com.attin.reactive.r6DesingPatterns.creational.builder.lamda.fluentShopping;
...
public class Order {
    ...
    public static void place(Function<Order, Order> function) {
        ...
        System.out.printf("\n%s items ordered by  you will be delivered at '%s' by tomorrow ", order.cart.size(), order.address);
    }
